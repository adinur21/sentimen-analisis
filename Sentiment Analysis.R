...
install.packages('rsconnect') #for connect to shiny.io
...
# Find associations 
findAssocs(TextDoc_dtm, terms = c("day","punish","earth"), corlimit = 0.25)
...
quickplot(sentiment, data=td_new2, weight=count, geom="bar",fill=sentiment,ylab="count")+ggtitle("Survey sentiments Al quran 30 Juz")
...
#  cex.names = 0.7, 
#  las = 1, 
#  main = "Emosididalamtext", xlab="Percentage"
)